          ...
          <View className={`px-5 flex-1 justify-between ${ios? 'mt-5': ''}`}>
            <View className="space-y-3 mt-3">
              ...
              <View style={{backgroundColor: 'rgba(255,255,255,0.2)'}} 
                className="flex-row items-center rounded-1xl p-1 px-2 space-x-1 ">
                <Text className="text-base font-semibold text-white">{item.desc}</Text>
              </View>
            ...
            <View style={{
              ...
              style={{
                ...
                <CheckCircleIcon size="25" strokeWidth={2} color={themeColors.bgDark} />
              </TouchableOpacity>
            </View>
